...
const Registration = () => {
  ...
  const handleSignup = async (e)=>{
    ...
    try {
      ...
      toast.success(`Hey ${result.data.name}, You are registered successfully!!`)
    } catch (error) {
      console.log(error);
  ...
  return (
    <div className='w-full h-auto bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start overflow-x-hidden'>
      <div className='w-[100%] h-[80px] flex items-center justify-start px-[30px] gap-[10px] cursor-pointer fixed' onClick={()=>navigate("/")}>
