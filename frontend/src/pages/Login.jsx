...
const Login = () => {
  ...
  const handleLogin = async(e)=>{
    ...
    try {
      ...
      toast.success(`Hey ${result.data.name}, You are logged in successfully!!`)
      getCurrentUser();
      navigate("/");
    } catch (error) {
      console.log(error);
  ...
  return (
    <div className='w-full h-auto bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start overflow-x-hidden'>
      ...
      <div className='w-screen h-[100px] flex items-center justify-center flex-col gap-[10px]'>
        ...
        <span className='text-[16px] text-[#d9cfcf]'>Welcome to ShopIQ , Place your order</span>

      </div>
      <div className='max-w-[600px] w-[90%] h-[500px] bg-[#00000025 border-[1px] border-[#96969635] backdrop-blur-2xl rounded-lg shadow-lg flex items-center justify-center mb-10'>
        <form action="" onSubmit={handleLogin} className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]' >
            ...
            <div className='w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px] relative'>
                ...
                <p className='flex gap-[10px]'>You haven't any account?<span className='text-[#5555f6cf] text-[17px] font-semibold cursor-pointer' onClick={()=>navigate("/signup")}>Create Account</span></p>
